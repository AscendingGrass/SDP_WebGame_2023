...
export default function loadAsset():void{
    ...
    redgrass.src = "./dist/Assets/Prototype/itland_ptype_redgrasstile.png"
    ...
    player2_idle.src = "./dist/Assets/Prototype/itland_ptype_player2_idle.png"
    const player2_walk = new Image()
    player2_walk.src = "./dist/Assets/Prototype/itland_ptype_player2_walk.png"
